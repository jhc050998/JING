...
public class SubWin1 extends JFrame
{
    //导入窗口所用的图片
    Image subWinTag1_Img = Toolkit.getDefaultToolkit().getImage(
            SubWin1.class.getResource("subWinTag1.png"));
    ImageIcon subWinTag1_Icon = new ImageIcon(subWinTag1_Img);
    JLabel subWinTag1_Lb;
    ...
    public SubWin1()
    {
        ...
        //标签
        this.subWinTag1_Lb = new JLabel(this.subWinTag1_Icon);
        this.subWinTag1_Lb.setBounds(50,10,250,100);
