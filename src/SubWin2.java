...
public class SubWin2 extends JFrame
{
    //导入窗口所用的图片
    Image subWinTag2_Img = Toolkit.getDefaultToolkit().getImage(
            SubWin1.class.getResource("subWinTag2.png"));
    ImageIcon subWinTag2_Icon = new ImageIcon(subWinTag2_Img);
    JLabel subWinTag2_Lb;
    ...
    public SubWin2()
    {
        ...
        //标签
        this.subWinTag2_Lb = new JLabel(this.subWinTag2_Icon);
        this.subWinTag2_Lb.setBounds(50,10,250,100);
